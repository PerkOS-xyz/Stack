...
DROP TABLE IF EXISTS perkos_reviews CASCADE;
DROP TABLE IF EXISTS perkos_network_stats CASCADE;
DROP TABLE IF EXISTS perkos_vouchers CASCADE;
DROP TABLE IF EXISTS perkos_transactions CASCADE;
DROP TABLE IF EXISTS perkos_agents CASCADE;

-- Drop existing functions
DROP FUNCTION IF EXISTS update_updated_at_column() CASCADE;
DROP FUNCTION IF EXISTS update_agent_stats(TEXT) CASCADE;
DROP FUNCTION IF EXISTS trigger_update_agent_stats() CASCADE;
DROP FUNCTION IF EXISTS aggregate_network_stats(DATE, TEXT) CASCADE;
...
CREATE INDEX idx_perkos_transactions_hash ON perkos_transactions(hash);
CREATE INDEX idx_perkos_transactions_network ON perkos_transactions(network);
CREATE INDEX idx_perkos_transactions_payer ON perkos_transactions(payer);
CREATE INDEX idx_perkos_transactions_payee ON perkos_transactions(payee);
CREATE INDEX idx_perkos_transactions_status ON perkos_transactions(status);
CREATE INDEX idx_perkos_transactions_created_at ON perkos_transactions(created_at DESC);
CREATE INDEX idx_perkos_transactions_network_created ON perkos_transactions(network, created_at DESC);
...
CREATE INDEX idx_perkos_vouchers_buyer ON perkos_vouchers(buyer);
CREATE INDEX idx_perkos_vouchers_seller ON perkos_vouchers(seller);
CREATE INDEX idx_perkos_vouchers_settled ON perkos_vouchers(settled);
CREATE INDEX idx_perkos_vouchers_created_at ON perkos_vouchers(created_at DESC);
...
CREATE INDEX idx_perkos_agents_address ON perkos_agents(address);
CREATE INDEX idx_perkos_agents_total_transactions ON perkos_agents(total_transactions DESC);
CREATE INDEX idx_perkos_agents_average_rating ON perkos_agents(average_rating DESC);
...
CREATE INDEX idx_perkos_reviews_agent_id ON perkos_reviews(agent_id);
CREATE INDEX idx_perkos_reviews_reviewer ON perkos_reviews(reviewer_address);
CREATE INDEX idx_perkos_reviews_created_at ON perkos_reviews(created_at DESC);
...
CREATE INDEX idx_perkos_network_stats_network ON perkos_network_stats(network);
CREATE INDEX idx_perkos_network_stats_date ON perkos_network_stats(date DESC);
CREATE INDEX idx_perkos_network_stats_network_date ON perkos_network_stats(network, date DESC);
