 ...
 * @notice Escrow contract for x402 deferred payment scheme
 * @dev Implements voucher-based payments with EIP-712 signatures
 */
contract DeferredPaymentEscrow is EIP712, ReentrancyGuard {
    ...
    constructor() EIP712("X402DeferredEscrow", "1") {}
