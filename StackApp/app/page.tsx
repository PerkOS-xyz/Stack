...
const { isValid, payer } = await response.json();`}
        ...
        <section id="contact" className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-slate-800/30 border border-blue-500/20 rounded-2xl p-8 backdrop-blur-sm">
              <ContactForm />
            </div>
            ...
            <div className="mt-8 grid md:grid-cols-3 gap-4">
              <a
                href="mailto:contact@perkos.io"
                className="flex items-center justify-center space-x-3 p-4 bg-slate-800/30 border border-slate-700/50 rounded-xl hover:border-cyan-500/30 hover:bg-slate-800/50 transition-all duration-200 group"
              >
                <svg className="w-5 h-5 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-300 group-hover:text-cyan-400 transition-colors">contact@perkos.io</span>
              </a>

              <a
                href="https://twitter.com/perkos_io"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center space-x-3 p-4 bg-slate-800/30 border border-slate-700/50 rounded-xl hover:border-cyan-500/30 hover:bg-slate-800/50 transition-all duration-200 group"
              >
                ...
                <span className="text-gray-300 group-hover:text-cyan-400 transition-colors">@perkos_io</span>
              </a>

              <a
                href="https://github.com/perkos-io"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center space-x-3 p-4 bg-slate-800/30 border border-slate-700/50 rounded-xl hover:border-cyan-500/30 hover:bg-slate-800/50 transition-all duration-200 group"
              >
