              ...
              <div className="relative p-6">
                ...
                <div className="relative mb-8">
                  <button
                    ...
                    className="flex items-center space-x-2 px-4 py-2.5 rounded-xl bg-slate-800/80 border border-blue-500/20 hover:border-cyan-500/40 transition-all backdrop-blur-sm"
                  >
                  ...
                  {/* Network Dropdown */}
                  {showNetworkSelector && (
                    <div className="absolute top-full left-0 mt-2 w-72 py-2 bg-slate-800/95 border border-blue-500/20 rounded-2xl shadow-2xl shadow-black/50 z-50 max-h-80 overflow-y-auto backdrop-blur-xl">
