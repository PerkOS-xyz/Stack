...
export const config = {
  ...
  rpcUrls: {
    ...
    sepolia: process.env.NEXT_PUBLIC_SEPOLIA_RPC_URL || "https://11155111.rpc.thirdweb.com",
    polygon: process.env.NEXT_PUBLIC_POLYGON_RPC_URL || "https://polygon-rpc.com",
    "polygon-amoy": process.env.NEXT_PUBLIC_POLYGON_AMOY_RPC_URL || "https://polygon-amoy-bor-rpc.publicnode.com",
    ...
    megaeth: process.env.NEXT_PUBLIC_MEGAETH_RPC_URL || "https://mainnet.megaeth.com/rpc",
    "megaeth-testnet": process.env.NEXT_PUBLIC_MEGAETH_TESTNET_RPC_URL || "https://carrot.megaeth.com/rpc",
    abstract: process.env.NEXT_PUBLIC_ABSTRACT_RPC_URL || "https://api.mainnet.abs.xyz",
    "abstract-testnet": process.env.NEXT_PUBLIC_ABSTRACT_TESTNET_RPC_URL || "https://api.testnet.abs.xyz",
  ...
  deferredEscrowAddresses: {
    ...
    "linea-sepolia": process.env.NEXT_PUBLIC_LINEA_SEPOLIA_ESCROW_ADDRESS as Address | undefined,
    gnosis: process.env.NEXT_PUBLIC_GNOSIS_ESCROW_ADDRESS as Address | undefined,
    "gnosis-chiado": process.env.NEXT_PUBLIC_GNOSIS_CHIADO_ESCROW_ADDRESS as Address | undefined,
    mantle: process.env.NEXT_PUBLIC_MANTLE_ESCROW_ADDRESS as Address | undefined,
    "mantle-sepolia": process.env.NEXT_PUBLIC_MANTLE_SEPOLIA_ESCROW_ADDRESS as Address | undefined,
    metis: process.env.NEXT_PUBLIC_METIS_ESCROW_ADDRESS as Address | undefined,
    "metis-sepolia": process.env.NEXT_PUBLIC_METIS_SEPOLIA_ESCROW_ADDRESS as Address | undefined,
    megaeth: process.env.NEXT_PUBLIC_MEGAETH_ESCROW_ADDRESS as Address | undefined,
    "megaeth-testnet": process.env.NEXT_PUBLIC_MEGAETH_TESTNET_ESCROW_ADDRESS as Address | undefined,
    abstract: process.env.NEXT_PUBLIC_ABSTRACT_ESCROW_ADDRESS as Address | undefined,
    "abstract-testnet": process.env.NEXT_PUBLIC_ABSTRACT_TESTNET_ESCROW_ADDRESS as Address | undefined,
    goat: process.env.NEXT_PUBLIC_GOAT_ESCROW_ADDRESS as Address | undefined,
    "goat-testnet": process.env.NEXT_PUBLIC_GOAT_TESTNET_ESCROW_ADDRESS as Address | undefined,
  },
